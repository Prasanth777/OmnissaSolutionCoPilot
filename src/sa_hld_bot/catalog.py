...
HORIZON_8 = Product(
    ...
    follow_up_questions=(
        ...
        q("desktop_image_version", "Which Windows desktop image version should be captured?", "Provide the Windows 11 release/build where known, or mark it to be confirmed.", ("Windows 11 24H2", "Windows 11 23H2", "Windows 11 - provide version", UNKNOWN), multi_select=True),
        q("server_image_version", "Which Windows Server image version should be captured?", "Select the server OS image version for RDSH or server-hosted workloads.", ("Windows Server 2025", "Windows Server 2022", "Windows Server 2016", UNKNOWN), multi_select=True),
